...
public final class ConnectionPool {
    ...
    private static ConnectionPool instance = new ConnectionPool("jdbc:mysql://localhost:3306/library?characterEncoding=UTF-8","com.mysql.jdbc.Driver", "root", "775678896Deo", 5);
